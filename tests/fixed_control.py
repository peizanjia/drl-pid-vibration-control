...
class StateSpace:
    ...
    def plot_voltage_time(self):
        ...
        plt.savefig('normal_noise_fixed_control.jpg')
...
mt = config_loader.load_mat()
noise_term = utils.create_noise_data(10000, option='normal', config=config, mt_data=mt)
state_space = StateSpace(config, noise_term, 0.01, 10000, 0.005,
                         300, 0, 0)
state_space.solve()
